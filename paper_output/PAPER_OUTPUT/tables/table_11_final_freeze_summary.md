| metric | value | notes |
| --- | --- | --- |
| freeze_allowed | True | Final freeze gate |
| paper_ready | False | Paper readiness gate |
| blocking_reasons | cross_validation_not_interpretable; systematic_matching_failure_detected | Must be resolved before final empirical claims |
...
| news_company_focused_dataset_size | 69 | Strict company-focused subset for robustness |
| news_suspect_or_manual_review_count | 56 | Excluded from strict company-focused sample before validation |
...
| claim_link_count | 316 | Cross-validation links |
...
| mock_mode | True | Claim-level scoring mode |
| systemic_conflict_flag | True | Unresolved claim-level conflict flag |
