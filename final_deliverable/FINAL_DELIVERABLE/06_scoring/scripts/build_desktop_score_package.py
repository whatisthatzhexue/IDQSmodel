...
DESKTOP_SCORE_DIR = Path("Desktop/score")
...
def sanitize_text(text: str) -> str:
    text = text.replace("Desktop/score", "<DESKTOP_SCORE>")
    text = text.replace("06_scoring", "<PROJECT_ROOT>")
    text = text.replace(".", "<PROJECT_PARENT>")
    text = text.replace("<LOCAL_USER>", "<USER_HOME>")
    return text
